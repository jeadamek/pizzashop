...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pediro: 4588512sd</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Jessica Adamek</TableCell>
            </TableRow>

            <TableRow>
              <TableCell className="text-muted-foreground-">Telefone</TableCell>
              <TableCell className="flex justify-end">(11) 6555-5600</TableCell>
            </TableRow>
